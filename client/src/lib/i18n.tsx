...
export const content: Translations = {
  ...
  partner2Desc: { ar: 'الموزع الحصري لحلول امن المعلومات والتقنيات الذكية، وتشمل أنظمة الحماية المتقدمة، التليماتكس، والإلكترونيات المتطورة للسيارات.', en: 'Exclusive distributor of information security solutions and smart technologies, including advanced protection systems, telematics, and advanced automotive electronics.' },
